    ...
    <section className="py-12 border-b border-border/80 last:border-b-0 transition-colors duration-300">
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="font-sans text-2xl font-black text-foreground">{title}</h2>
        </div>
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        ...
        <Link href={getArticleUrl(featured)} className="group flex flex-col gap-5 lg:col-span-7">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-3 font-mono text-[10px] text-muted-foreground">
              <span className="font-semibold text-foreground">
                {getAuthorFullName(featured.author)}
              </span>
              <span>•</span>
